"""
ALGO-LIFE PDF Generator v7.1 ULTRA PREMIUM (PATCHED)
✅ Fix: matplotlib alpha clamp (évite ValueError alpha > 1.0)
✅ Fix: couleur HTML dans Paragraph (<font color="#RRGGBB">) au lieu de .hexval() reportlab
...
def create_bioage_ultra_premium(bio_age, chrono_age):
    ...
    # ✅ alpha clamp -> évite 1.0000000000000007
...
def generate_algolife_pdf_report(
    ...
    """
    ⭐ Générateur PDF ULTRA PREMIUM v7.1 (PATCHED)
    ...
    meta_data = [[
        ...
        Paragraph("<b>Version</b><br/>v7.1 Premium", small_style)
    ]]
    ...
    for raw_key, value in iterable:
        ...
        cls = biomarker_db.classify_biomarker(
            key, value,
...
if __name__ == "__main__":
    print("✅ ALGO-LIFE PDF Generator v7.1 ULTRA PREMIUM (PATCHED)")
